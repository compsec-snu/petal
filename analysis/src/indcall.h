...
#define DEBUG_TYPE "indcall"

class indcall : public ModulePass
{
    private:
        virtual bool runOnModule(Module &) override;
        bool indcallPass(Module &);
        ...
        void export_func_code();

        void my_debug(Module& module);

        int getFuncCode(Function *func);
    public:
        static char ID;
        indcall() : ModulePass(ID){};
 ...
 */
        ...
        InstructionSet dummyCE;
        InstFuncMap dummyCE_map;
